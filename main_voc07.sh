...
test_list='./data/VOCdevkit/VOC2007/ImageSets/Main/test.txt'
train_label='./data/VOCdevkit/VOC2007/Annotations'
test_label='./data/VOCdevkit/VOC2007/Annotations'

graph_file='./data/VOCdevkit/VOC2007/prob_trainval.npy'
word_file='./data/VOCdevkit/VOC2007/voc07_vector.npy'
batch_size=4
epochs=200
learning_rate=1e-5
momentum=0.9
